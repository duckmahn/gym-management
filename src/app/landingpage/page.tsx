...
export default function Landingpage() {
    ...
    const readMembership = async () => {
      ...
      try {
        if (response.status === 200) {
          setMemberships(response.data.JSON)
        }
      } catch (error) {
  ...
  useEffect(() => {
    const readTrainer = async () => {
      ...
      try {
        if (response.status === 200) {
          setTrainers(response.data.JSON)
        }
      } catch (error) {
        if (response.status === 401) {
          setError("Unauthorized")
    ...
    <div className="px-[50px] py-[25px] bg-black">
      <div className="fixed left-0 top-0 w-full bg-black pl-[50px] pt-[25px] flex flex-row">
        <div className="w-[50px] h-[50px] mr-[10px]">
          <img className="w-full h-full" src="/images/first/logo.png" />
        </div>
        ...
        <div className="ml-[10px]">
          <button className="mr-[5px] border border-[1px] border-orangered rounded p-[5px] text-orangered hover:bg-orangered text-white">
            <Link to="/login">Login</Link>
          </button>
          <button className="ml-[5px] border border-[1px] border-orangered rounded p-[5px] text-orangered hover:bg-orangered text-white">
      ...
      <div id="home" className="w-full my-[50px] flex flex-row">
        <div className="w-[50%] flex flex-col justify-center items-center">
          ...
          <div className="w-full mt-[10px] flex flex-row justify-center">
            <button className="w-[49%] bg-orangered mr-[10px] rounded-[15px] py-[5px] font-bold text-2xl text-white hover:opacity-50">
              Start Your Journey
            </button>
            <button className="w-[49%] bg-orangered ml-[10px] rounded-[15px] py-[5px] font-bold text-2xl text-white hover:opacity-50">
              Explore Programs
            </button>
          </div>
        </div>
        <div className="w-[50%]">
          <img className="w-full h-full" src="/images/bg.png" />
        </div>
      </div>

      <div className="w-full my-[50px] flex flex-row justify-center">
      ...
      >
        ...
        <div className="w-full mt-[5px] flex flex-wrap">
          <div className="w-auto mr-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/four/image1.png" />
            </div>
            <div className="relative left-[20px] bottom-[20px]">
              <a
          ...
          <div className="w-auto mr-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/four/image2.png" />
            </div>
            <div className="relative left-[20px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/four/image3.png" />
            </div>
            <div className="relative left-[20px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/four/image4.png" />
            </div>
            <div className="relative left-[20px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
      ...
      >
        ...
        <div className="w-full mt-[5px] flex flex-wrap">
          {memberships.map((membership) => (
            <div
              key={membership.id}
              className="w-[30%] mx-[10px] border-[3px] border-orangered rounded p-[10px] flex flex-col items-center"
            >
              ...
              <div className="w-full">
                <button className="w-full bg-orangered rounded-[15px] py-[10px] text-white hover:opacity-50">
                  Choose This Plan
                </button>
              </div>
            </div>
      ...
      >
        ...
        <div className="w-full mt-[5px] flex flex-wrap">
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/six/image1.png" />
            </div>
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/six/image2.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/six/image3.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/six/image4.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
      ...
      <div className="w-full my-[50px] flex flex-col items-center">
        <div className="w-full mb-[10px]">
          ...
          <div className="float-right">
            <button
              className="bg-orangered mr-[5px] p-[5px] rounded text-white hover:opacity-50"
              onClick={Previous}
            >
              Previous
            </button>
            <button
              className="bg-orangered ml-[5px] p-[5px] rounded text-white hover:opacity-50"
              onClick={Next}
            >
              Next
            </button>
        ...
        <div className="w-full mt-[5px]">
          <img
            className="float-left w-[50%] border-r border-r-[3px] border-r-orangered rounded pr-[10px]"
      ...
      >
        ...
        <div className="w-full mt-[5px] flex flex-wrap">
          {trainers.map((trainer) => (
            <div key={trainer.id} className="w-auto mr-[10px] rounded">
              <div className="static">
                <img className="w-full h-full" src="/images/eight/image2.png" />
              </div>
              <div className="relative left-[20px] bottom-[100px] flex flex-col">
      ...
      >
        ...
        <div className="w-full mt-[5px] flex flex-wrap">
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/nine/image1.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/nine/image2.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/nine/image3.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
          ...
          <div className="w-auto mr-[10px] mb-[10px] rounded">
            <div className="static">
              <img className="w-full h-full" src="/images/nine/image4.png" />
            </div>
            <div className="relative left-[10px] bottom-[20px]">
              <a
                className="inline-block list-none font-light text-white hover:opacity-50"
        ...
        <div className="w-[50%]">
          ...
          <div className="w-full">
            <img
              ...
              src="/images/twelve/socialmedia.png"
            />
          </div>
        </div>
