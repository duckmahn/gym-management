...
export default function LandingPage() {
  return (
    <div className="landingpage">
      <div className="first">
        <div className="fivar">
          <img src="/images/first/first1.png" alt="alt3" />
        </div>
        ...
        <div className="fitwo">
          <button>
            <img src="/images/first/first2.png" alt="alt2" />
          </button>
        </div>
      ...
      <div className="second">
        <div className="sleft">
          ...
          <div className="smid">
            ...
            To Help You Achive Your Goals And Exceed Your Expectations. Ready To
            Make A Change?&quot;
          </div>
          <div className="sbot">
      ...
      <div className="eleven">
        <div className="eltop">FAQ</div>
        <div className="elbot">
          <div className="elonce">
            What Is Fitmaker And How Can It Help Me Reach My Fitness Goal?
          </div>
          <div className="eltwo">
            How Do I Get Started With A Workout Plan On Maker?
          </div>
          <div className="elthree">What Is Included In The Custom Plan?</div>
          <div className="elfour">Can I Change My Plan After Signing Up?</div>
          <div className="elfive">
