    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingTrainers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealInfos", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("dd4647e5-aaca-4ebd-8500-a871721ee546"), null, null, "admin@gym.com", "Admin", true, "User", null, "Admin@123", null, "admin" });
        }
