...
export default function Setting() {
  ...
  <img src="setting-2.jpg" alt="Button Image" />
     ...
     <div className="background-small">
      <div className="textkhoahoc">Thông tin khóa học</div>
      <div className="yogaBox">
        <div className="textYoga">Khóa học Yoga</div>
        <div className="textsmall">Phòng học: Yoga 1</div>
        <div className="textsmall">Thời gian: 3 tháng</div>
        <div className="textsmall">Tên huấn luyện viên: James</div>
        <div className="textsmall">Giờ học: 18-19h30, Thứ 3, Thứ 7</div>
        <div className="dangkyBox">Đăng ký</div>
